...
path = r'D:\Fotos-Videos\olte pumpereidn\Test\40s.mp4' #Pfad zum Video
path_template = r'D:\Fotos-Videos\olte pumpereidn\Template_yellow4.jpg' #Pfad zum Vorlagenbild
...
while (True):
    # jeden Frame einzeln extrahieren
    ret, im = cap.read()
    nummer += 1
    try:
        if im.shape[0] > 4000:
